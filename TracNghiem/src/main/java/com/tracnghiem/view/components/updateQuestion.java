 ...
 * @author huulu
 */
public class updateQuestion extends javax.swing.JPanel {
    ...
    private final ArrayList<JLabel> listLabelID = new ArrayList<>();
     ...
     */
    public updateQuestion(QuestionDTO question, boolean update) {
        initComponents();
        ...
        listLabelID.add(aID1);
        listLabelID.add(aID2);
        listLabelID.add(aID3);
        listLabelID.add(aID4);
        listLabelID.add(aID5);
        ...
        q = question;
        qID = q.getQID();
        listA = aBUS.getByQuesID(q.getQID());
    ...
    private void initComponents() {
        ...
        cbbLevel.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Easy", "Medium", "Diff" }));
        ...
        panelA.add(aID1, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 0, -1, -1));
        aID1.setVisible(false);
        ...
        panelB.add(aID2, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 0, -1, -1));
        aID2.setVisible(false);
        ...
        panelC.add(aID3, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 0, -1, -1));
        aID3.setVisible(false);
        ...
        panelD.add(aID4, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 0, -1, -1));
        aID4.setVisible(false);
        ...
        panelE.add(aID5, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 0, -1, -1));
        aID5.setVisible(false);
    ...
    private void loadDataEdit() {
        ...
        if (listTp.size() == 3) {
            ...
            loadTpChild(listTp.get(2).getTpID());
            chudeCBB.setSelectedItem(listTp.get(1).getTpTitle());

             
            baihocCBB.addItem(listTp.get(0).getTpTitle());
            loadTpChild1(listTp.get(1).getTpID());
            baihocCBB.setSelectedItem(listTp.get(0).getTpTitle());
        }
        else if (listTp.size() == 2) {
            monhocCBB.addItem(listTp.get(1).getTpTitle());
            loadTpParent(tBUS.getAllParent());
            monhocCBB.setSelectedItem(listTp.get(1).getTpTitle());
            
            chudeCBB.addItem(listTp.get(0).getTpTitle());
            loadTpChild(listTp.get(1).getTpID());
            chudeCBB.setSelectedItem(listTp.get(0).getTpTitle());
             
        }
        else {
            monhocCBB.addItem(listTp.get(0).getTpTitle());
            loadTpParent(tBUS.getAllParent());
            monhocCBB.setSelectedItem(listTp.get(0).getTpTitle());
        }  
        ...
        for (int i = 0; i < listA.size(); i++) {
            ...
            listLabel.get(i).setText(listA.get(i).getAwPicture().isEmpty() ? "Chưa chọn ảnh" : listA.get(i).getAwPicture());
            listLabelID.get(i).setText(listA.get(i).getAwID()+"");
    ...
    private void loadPrevImage(String fileName) {
...
//      
       // Kiểm tra xem file có tồn tại không trước khi tạo ImageIcon
        URL imageUrl = updateQuestion.class.getResource("/images/" + fileName);
        if (imageUrl == null) {
            for (int i = 0; i < listImg.size(); i++) {
                if (listImg.get(i).getName().equals(fileName)) {
...
//        }
    ...
    private void buildDataQuestion() {
        ...
        //Question        
        int updateQTopicID = tIDSelected;
        ...
        //Answer
        String updateAwContent ;
        String updateAwPicture ;
        boolean updateAwIsRight ;
        int updateAwStatus = 1;
        
        listA.clear();
        
        for (int i = 0; i < listTextArea.size(); i++) {
            if (!listTextArea.get(i).getText().isEmpty()) {
                updateAwContent = listTextArea.get(i).getText();
                updateAwPicture = listLabel.get(i).getText();
                
                if (updateAwPicture.equals("NULL") || updateAwPicture.equals("Chưa chọn ảnh")) {
                    updateAwPicture = "";
                }
                
                updateAwIsRight = listRBTn.get(i).isSelected();
                
                AnswerDTO a = new AnswerDTO(Integer.parseInt(listLabelID.get(i).getText()),q.getQID(), updateAwContent, updateAwPicture, updateAwIsRight, updateAwStatus);
                listA.add(a);
            }
        }
